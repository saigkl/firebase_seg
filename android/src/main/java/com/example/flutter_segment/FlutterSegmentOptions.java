...
public class FlutterSegmentOptions {
    ...
    public  FlutterSegmentOptions(String writeKey, Boolean trackApplicationLifecycleEvents, Boolean amplitudeIntegrationEnabled,Boolean moengageIntegrationEnabled, Boolean debug) {
    ...
    static FlutterSegmentOptions create(Bundle bundle) {
        ...
        return new FlutterSegmentOptions(writeKey, trackApplicationLifecycleEvents, isAmplitudeIntegrationEnabled,isMoengageIntegrationEnabled, debug);
    }
